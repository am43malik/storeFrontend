...
const handelDeleterow = async(deleteRow)=>{
  ...
  axios.post(`${process.env.REACT_APP_DEVELOPMENT}/api/stock/deleteStockOut`,{stockOutId:deleteRow._id,quantity:parseInt(deleteRow.quantity),expiry:deleteRow.expiry,productName:deleteRow.productName},{headers:{token:accessToken}})
