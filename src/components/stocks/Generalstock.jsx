...
const Generalstock = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error('Error fetching general stock data:', error);
      }
    };
  ...
  const handleExport = () => {
    ...
    saveAs(new Blob([excelBuffer], { type: 'application/octet-stream' }), 'GENERAL stock.xlsx');
  };
  ...
  return (
    <div className="row">
      ...
      <div className="col-xs-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 dashboard-container">
        <h1 className="my-5 title text-center">GENERAL Stock</h1>
